...
#      ########################################\n\n"
        ...
        prefix = str(input("Notebook(n) oder Desktop(d): "))
        ...
        while q is True:
            ...
            if s_nummer[0] == "Ü" or s_nummer[0] == "ü":
                with open(str(projekt)+'_serialnummer und anlagenummer_'+str(date)+'.csv', 'w') as f:
                    f.write(projekt)
                    f.write("\n")
                    f.write("  S-Nummer;A-Nummer;    Hostname")
                    f.write("\n")
